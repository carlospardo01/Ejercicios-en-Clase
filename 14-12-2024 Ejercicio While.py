...
while contador < limite:
    ...
    contador += 1
    #compara si la respuesta es correcta, imprime un mensaje en pantalla y rompe el bucle si responde bien, de lo contrario vuelve a intentarlo hasta que acaba el bucle.
